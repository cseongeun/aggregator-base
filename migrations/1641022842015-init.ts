...
export class init1641022842015 implements MigrationInterface {
    name = 'init1641022842015'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`token\` (\`status\` tinyint NOT NULL DEFAULT 1, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp NULL, \`id\` bigint NOT NULL AUTO_INCREMENT, \`type\` enum ('NATIVE', 'SINGLE', 'MULTI') NOT NULL, \`name\` varchar(255) NOT NULL, \`symbol\` varchar(255) NOT NULL, \`address\` varchar(255) NOT NULL, \`decimals\` int NOT NULL, \`total_supply\` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', \`price_address\` varchar(255) NULL, \`price_value\` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', \`before_day_price_value\` json NULL, \`logo_link\` varchar(255) NULL, \`swap_base\` tinyint NOT NULL DEFAULT 0, \`network_id\` bigint NOT NULL, \`pair0_id\` bigint NULL, \`pair1_id\` bigint NULL, \`wrapped_id\` bigint NULL, UNIQUE INDEX \`idx_token_1\` (\`network_id\`, \`address\`), UNIQUE INDEX \`REL_d320e3ab211b71e5caae7cd61e\` (\`wrapped_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`scheduler\` (\`status\` tinyint NOT NULL DEFAULT 1, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp NULL, \`id\` varchar(36) NOT NULL, \`type\` varchar(255) NOT NULL, \`identity\` varchar(255) NOT NULL, \`cron\` varchar(255) NOT NULL, \`block_number\` int NULL DEFAULT '0', \`pid\` int NULL, \`data\` text NOT NULL, \`error\` tinyint NOT NULL DEFAULT 0, \`process\` tinyint NOT NULL DEFAULT '0', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`token_price\` (\`status\` tinyint NOT NULL DEFAULT 1, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp NULL, \`id\` bigint NOT NULL AUTO_INCREMENT, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
